...
export function logger<TFunction extends Function>(constructor: TFunction): TFunction {
    const newConctructor: Function = function () {
    ...
    newConctructor.prototype = Object.create(constructor.prototype);

    newConctructor.prototype.printLibrarian = function (): void {
        console.log(`Librarian name: ${this.name}, Librarian age: ${this.age}`);
    };

    return newConctructor as TFunction;
}
